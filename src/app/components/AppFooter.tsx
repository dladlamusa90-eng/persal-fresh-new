...
export default function AppFooter({ isAuthenticated = false }: AppFooterProps) {
  return (
    <footer className="w-full bg-[#0c5c5f] text-teal-100 py-10 mt-12">
        ...
        <div id="join-our-community" className="flex flex-col items-center md:items-end">
          ...
          <form className="w-full md:w-auto flex items-center gap-2 mb-3" action="#" method="post">
            <input
              ...
              className="w-full md:w-56 rounded-md border border-teal-200/40 bg-white/95 px-3 py-1.5 text-sm text-gray-800 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-teal-300"
            />
            <button
              type="submit"
